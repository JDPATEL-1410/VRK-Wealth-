...
import { Repeat, PieChart as PieChartIcon, Download, ArrowRight, IndianRupee, Calendar, TrendingUp } from 'lucide-react';
...
export function STPCalculator() {
    ...
    const downloadReport = async () => {
        try {
            ...
            pdf.save(`VRK-Wealth-STP-Report.pdf`);
        } catch (error) {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <PageHeader
                ...
                icon={<Repeat className="w-16 h-16 text-[#0d9488]" />}
            />
